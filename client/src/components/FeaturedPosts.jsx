...
const fetchPost = async () => { 
  const res = await axios.get(`${import.meta.env.VITE_API_URL}/posts/posts?featured=true&limit=4&sort=newest`)
    ...
    <div className='mt-8 flex flex-col lg:flex-row gap-8'>
         ...
         { posts[1] &&  <div className="lg:h-1/3 flex justify-between gap-4">
            ...
            <div className="flex items-center gap-4 text-sm lg:text-base mb-4">
                    ...
                    <Link to="/posts?cat=web-design" className='text-blue-800'>{posts[1].category}</Link>
           ...
           { posts[2] &&  <div className="lg:h-1/3 flex justify-between gap-4">
            ...
            <div className="flex items-center gap-4 text-sm lg:text-base mb-4">
                    <h1 className="font-semibold">02.</h1>
                    <Link to="/posts?cat=web-design" className='text-blue-800'>{posts[2].category}</Link>
         ...
         { posts[3] &&  <div className="lg:h-1/3 flex justify-between gap-4">
            ...
            <div className="flex items-center gap-4 text-sm lg:text-base mb-4">
                    <h1 className="font-semibold">02.</h1>
                    <Link to="/posts?cat=web-design" className='text-blue-800'>{posts[3].category}</Link>
